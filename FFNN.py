...
X_train_device_id, X_train = split_sets.split_feed_forward_sets(X_train)
...
X_test_device_id, X_test = split_sets.split_feed_forward_sets(X_test)
...
for i in range(0, 2):
    ...
    logging.info(
        f"Dataset: {dataset}, Hyperparameters of the best trial for model {i + 1}: {best_trial}")
