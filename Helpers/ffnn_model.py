...
class FNN(Model):
    ...
    Methods:
        ...
        objective(trial: optuna.trial._trial.Trial) -> float:
        ...
        hypertune_model(n_trials: int, direction: str) -> optuna.study.study.Study:
    ...
    def create_model(self, hp_prev: int, hp_prev_prev: int, hp_session: int, hp_device: int, hp_output: int,
        ...
        Args:
            ...
            hp_dropout (float): Value for the hyperparameter "dropout rate". 
            hp_activation (str): Value for the hyperparameter "activation function".
        Returns:
        ...
        for _ in range(hp_layers):
            concatenated = tf.keras.layers.Dense(
                units=hp_units, activation=hp_activation)(concatenated)
