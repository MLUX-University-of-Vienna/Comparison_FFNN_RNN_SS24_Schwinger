...
from Helpers.ffnn_only_content_id import *
...
X_train_prev_event, X_train = split_sets.split_feed_forward_sets(X_train)
X_train_prev_prev_event, X_train = split_sets.split_feed_forward_sets(X_train)
X_train_session_id, X_train = split_sets.split_feed_forward_sets(X_train)
X_train_content_id, X_train = split_sets.split_feed_forward_sets(X_train)

X_test_prev_event, X_test = split_sets.split_feed_forward_sets(X_test)
X_test_prev_prev_event, X_test = split_sets.split_feed_forward_sets(X_test)
X_test_session_id, X_test = split_sets.split_feed_forward_sets(X_test)
X_test_content_id, X_test = split_sets.split_feed_forward_sets(X_test)
...
ffnn = FNN_content(X_train_prev_event_input_dim, X_train_prev_prev_event_input_dim, X_train_session_id_input_dim, X_train,
...
X_train_inputs = [X_train_prev_event, X_train_prev_prev_event,
                  X_train_session_id, X_train, X_train_content_id]
X_test_inputs = [X_test_prev_event, X_test_prev_prev_event,
                 X_test_session_id, X_test, X_test_content_id]
eval_data = []
